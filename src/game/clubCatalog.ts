...
export function clubKitFor(clubName: string): ClubKit {
  ...
  return {
    ...
    shortsColour: pick(BADGE_PRIMARY),
    socksColour: pick(BADGE_SECONDARY),
...
export function applyKitToAppearance(
  ...
  return {
    ...
    shortsColour: kit.shortsColour,
    socksColour: kit.socksColour,
    ...
    shirtDesign: kit.shirtDesign ?? null,
    badgeDesign: kit.badgeDesign ?? null,
...
export function botAppearanceFor(
  ...
  return {
    ...
    shortsColour: strip.shortsColour,
    socksColour: strip.socksColour,
    ...
    shirtDesign: strip.shirtDesign ?? null,
    badgeDesign: strip.badgeDesign ?? null,
    clubName,
    clubRole: null,
    skinColour: "medium",
    hairColour: "brown",
